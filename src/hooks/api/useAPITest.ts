...
export const useAPITest = () => {
  ...
  const testAPIConnectivity = async () => {
    ...
    try {
      ...
      // Test RapidAPI
      try {
        const rapidApiUrl = new URL('https://travel-advisor.p.rapidapi.com/restaurants/list-by-latlng');
      ...
      try {
        ...
        googleUrl.searchParams.append('key', import.meta.env.VITE_GOOGLE_MAPS_API_KEY || '');
